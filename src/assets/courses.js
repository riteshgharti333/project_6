    ...
    listPoints: [
      {
        ...
        desc: "The program covers a diverse range of subjects, including visual arts, design principles, cultural studies, and contemporary trends, ensuring a well-rounded education.",
      },
      {
        title: "Experienced Faculty",
        desc: "Learn from industry experts and experienced educators who bring real-world insights and creative expertise into the classroom.",
      },
      {
        title: "Practical Exposure",
        desc: "Gain hands-on experience through workshops, design projects, and internships, enhancing your creative and technical skills.",
      },
      {
        title: "Career Opportunities",
        desc: "Graduates are prepared for careers in design agencies, advertising, content creation, media, and other creative industries.",
      },
    ],
  },
};
    ...
    listPoints: [
      {
        ...
        desc: "The program covers diverse subjects such as financial accounting, corporate finance, taxation, business law, marketing, and management principles, ensuring a well-rounded education.",
      },
      {
        title: "Industry-Experienced Faculty",
        desc: "Learn from seasoned professionals and industry experts who bring real-world experience and insights into the classroom, helping students bridge the gap between academics and industry practices.",
      },
      {
        title: "Practical Learning",
        desc: "Gain hands-on experience through case studies, business simulations, and projects. Participate in workshops and industry interactions to develop problem-solving and decision-making skills.",
      },
      {
        title: "Career Opportunities",
        desc: "Graduates of the B.Com program are well-prepared for careers in finance, banking, taxation, auditing, business analysis, and management consulting. The program also lays a strong foundation for pursuing higher studies such as M.Com, MBA, or professional certifications like CA, CFA, and ACCA.",
      },
    ],
  },
};
...
export const bScProgram = {
  ...
  list: {
    ...
    listPoints: [
      {
        title: "Specialized Curriculum",
        desc: "The program covers core science subjects such as Physics, Chemistry, Biology, Mathematics, and Computer Science. It also offers elective courses that allow students to specialize in their area of interest.",
      },
      {
        title: "Expert Faculty",
        desc: "Learn from experienced professors and industry professionals who bring their scientific expertise and practical insights into the classroom.",
      },
      {
        title: "Practical Exposure",
        desc: "Gain hands-on experience through laboratory experiments, research projects, and fieldwork. The program emphasizes practical applications of scientific concepts to develop technical competence.",
      },
      {
        title: "Career Opportunities",
        desc: "Graduates of the B.Sc program can pursue careers in research, healthcare, data science, biotechnology, environmental science, and information technology. The program also provides a solid foundation for higher studies such as M.Sc, MBA, or specialized certifications.",
      },
    ],
  },
};
    ...
    listPoints: [
      {
        ...
        desc: "The program covers essential business subjects such as management principles, marketing strategies, financial analysis, business law, and entrepreneurship, providing a solid foundation in business administration.",
      },
      {
        title: "Experienced Faculty",
        desc: "Learn from seasoned business professionals and industry experts who bring real-world insights and practical knowledge into the classroom.",
      },
      {
        title: "Practical Learning",
        desc: "Gain hands-on experience through case studies, internships, and business simulations. Develop strategic decision-making skills through real-world business scenarios.",
      },
      {
        title: "Career Opportunities",
        desc: "Graduates of the B.B.A program are well-prepared for careers in management, marketing, finance, human resources, and business consulting. The program also provides a strong foundation for higher studies such as MBA or specialized certifications.",
      },
    ],
  },
};
...
export const maProgram = {
  ...
  list: {
    ...
    listPoints: [
      {
        title: "Comprehensive Curriculum",
        desc: "The program covers advanced topics in literature, history, philosophy, sociology, and cultural studies, providing a broad and in-depth knowledge of the humanities.",
      },
      {
        title: "Expert Faculty",
        desc: "Learn from renowned scholars and experienced academicians who bring their expertise, research insights, and academic rigor into the classroom.",
      },
      {
        title: "Research and Thesis Projects",
        desc: "Engage in independent research projects and thesis work, allowing you to explore specialized topics and contribute to scholarly discussions in your field of interest.",
      },
      {
        title: "Career Opportunities",
        desc: "Graduates of the M.A program can pursue careers in education, research, publishing, public policy, journalism, and cultural organizations. The program also provides a strong foundation for doctoral studies (Ph.D.) or professional certifications.",
      },
    ],
  },
};
...
export const mComProgram = {
  ...
  list: {
    ...
    listPoints: [
      {
        title: "Specialized Curriculum",
        desc: "The program covers advanced subjects, including financial analysis, corporate governance, investment management, taxation, and strategic business management, equipping students with in-demand skills.",
      },
      {
        title: "Experienced Faculty",
        desc: "Learn from industry experts, financial analysts, and academic professionals who bring real-world experience and insights into the classroom.",
      },
      {
        title: "Practical Learning",
        desc: "Engage in case studies, business simulations, and financial modeling projects. Gain practical skills through industry-relevant research and problem-solving activities.",
      },
      {
        title: "Career Opportunities",
        desc: "Graduates of the M.Com program are well-prepared for careers in finance, banking, corporate management, auditing, taxation, and consulting. The program also provides a strong foundation for pursuing professional certifications such as CA, CFA, ACCA, or doctoral studies (Ph.D.).",
      },
    ],
  },
};
...
export const mScProgram = {
  ...
  list: {
    ...
    listPoints: [
      {
        title: "Advanced Scientific Curriculum",
        desc: "The program covers core and specialized scientific subjects such as advanced physics, molecular biology, applied mathematics, and data science, providing students with a deep and practical understanding of their field.",
      },
      {
        title: "Expert Faculty",
        desc: "Learn from renowned scientists, researchers, and academic professionals who bring extensive knowledge and industry experience into the classroom.",
      },
      {
        title: "Research and Lab Projects",
        desc: "Gain hands-on experience through laboratory experiments, scientific research, and data analysis projects. The program emphasizes practical applications and innovative research methodologies.",
      },
      {
        title: "Career Opportunities",
        desc: "Graduates of the M.Sc program are well-prepared for careers in research, healthcare, data science, biotechnology, environmental science, and academia. The program also provides a strong foundation for pursuing doctoral studies (Ph.D.) or specialized certifications.",
      },
    ],
  },
};
    ...
    listPoints: [
      {
        ...
        desc: "The program covers essential business areas, including corporate strategy, financial management, marketing analytics, organizational behavior, and business law, providing a well-rounded understanding of business operations.",
      },
      {
        title: "Experienced Industry Faculty",
        desc: "Learn from business leaders, corporate experts, and experienced academicians who bring real-world insights and strategic knowledge into the classroom.",
      },
      {
        title: "Practical Learning and Internships",
        desc: "Gain hands-on experience through live industry projects, business simulations, and internships. Collaborate with industry partners on real-world challenges to build practical skills.",
      },
      {
        title: "Career Opportunities",
